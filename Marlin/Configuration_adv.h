...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_NOZZLE_TARGET   220     // (°C) Safe temperature for the nozzle after timeout
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN             -1 // Pin to detect power-loss. Set to -1 to disable default pin on boards without module, or comment to use board default. // (3VD)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE         40  // (mm/s) Initial retract feedrate. (3VD)
  #define PAUSE_PARK_RETRACT_LENGTH            1  // (mm) Initial retract. (3VD)
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      50  // (mm) The length of filament for a complete unload. (3VD)
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   15  // (mm/s) Load filament feedrate. This can be pretty fast. (3VD)
  ...
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      15  // (mm/s) feedrate to purge before unload (3VD)
 ...
 */
  ...
  #define SERVICE_NAME_1      "Service S" // service (3VD)
  #define SERVICE_INTERVAL_1  100 // print hours
  #define SERVICE_NAME_2      "Service M" // maintenance (3VD)
